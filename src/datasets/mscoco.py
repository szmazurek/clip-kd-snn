"""MS-COCO retrieval evaluation dataset.

Expects the same directory layout as the original repo's RetrievalDataset:
  data_path/
    test_captions.pt     — dict {image_id: [caption1, caption2, ...]}
    test_img_keys.tsv    — one image_id per line
    images/val2014/      — COCO_val2014_<id>.jpg files
...
class MSCOCODataset(Dataset):
    """MS-COCO 5k test split for image-text retrieval evaluation.
    ...
    def __getitem__(self, idx: int):
        ...
        img_path = os.path.join(
            self.data_path,
            "images/val2014",
            f"COCO_val2014_{img_key:012d}.jpg",
        )
